...
export default function ProductCard({ id, name, desc, image, price, quantity }: productType) {
    return (
        <div className="max-w-md mx-auto rounded-md overflow-hidden shadow-md hover:shadow-lg" key={id}>
            ...
            <div className="p-4">
                ...
                <p className="text-gray-600 text-sm mb-4" style={{lineHeight: '1.5em' , height: '3em', overflow: 'hidden'}}>{desc}</p>
