...
export const metadata: Metadata = {
    title: "Abuout Us",
    description: "This is abouts page",
            ...
            <section className="sm:flex items-center max-w-screen-xl w-[90%] mx-auto">
                ...
                <div className="sm:w-1/2 p-5">
                    <div className="text">
                        ...
                        At VANN COMMERCE, were more than just an online cat store - were a family of cat lovers dedicated to enriching the lives of felines and their humans. We believe that cats deserve comfortable, stimulating environments that bring out their playful personalities. We source high-quality, ethically made products that promote wellness and joy for your furry companion.
                        </p>
                    </div>
                </div>
            </section>
